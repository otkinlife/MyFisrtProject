...
<div style="margin-top: 10px;">
  ...
  <div class="alert alert-warning" style="margin-left:10px;float: left; width: 30%;">
     <div class="input-group input-group" style="width: 100%;margin-top: 10px">
                ...
                <input type="text" class="form-control" name="username" placeholder="请输入邮箱" aria-describedby="sizing-addon1">
     </div>
      <div class="input-group input-group" style="width: 100%;margin-top: 10px">
                <span class="input-group-addon" id="sizing-addon1">用户密码</span>
                <input type="password" class="form-control" name="username" placeholder="请输入用户密码" aria-describedby="sizing-addon1">
      </div>
      <div class="input-group input-group" style="width: 100%;margin-top: 10px">
